                ...
                <Container>
                    <s.parentPart className="parentPart">
                        ...
                        <div className="dymamicPart">
                            ...
                            <Link href={router.REGISTERASWORKER} className="redBtn">I want to get hired</Link>
                            <p className="my-2">or</p>
                            <Link href={router.REGISTERASCOMPANY} className="redBtn">I want to hire</Link>
                            <div class="refLinks">
                                <p>Already registered? Click here to <Link href={router.LOGINASWORKER}>Login</Link></p>
                            </div>
                        </div>
                    </s.parentPart>
                </Container>
